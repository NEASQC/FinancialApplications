...
#SBATCH -t 04:00:00 
#SBATCH -C clk
#SBATCH --array=1-2,6-7,11-12,16-17
# SBATCH --array=0,5,10,15
...
srun -n 1 -c $SLURM_CPUS_PER_TASK python q_quick.py -id $SLURM_ARRAY_TASK_ID -repetitions 50 --print --save --exe 
